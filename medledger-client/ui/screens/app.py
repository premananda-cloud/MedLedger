...
class App(tk.Tk):
    ...
    def _on_uploaded(self, result: dict):
        """Called by UploadScreen after a successful upload. Caches record then shows list."""
        from ui.screens.records import RecordsScreen
        RecordsScreen.add_session_record(result)
        self._navigate("records")
